...
ifeq ($(config),debug32)
  OBJDIR              = ../../android-x86_64/obj/x32/Debug/example-glue
...
ifeq ($(config),release32)
  OBJDIR              = ../../android-x86_64/obj/x32/Release/example-glue
  TARGETDIR           = ../../android-x86_64/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../../android-x86_64/obj/x64/Debug/example-glue
  TARGETDIR           = ../../android-x86_64/bin
  TARGET              = $(TARGETDIR)/libexample-glueDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../../bx/include"
...
ifeq ($(config),release64)
  OBJDIR              = ../../android-x86_64/obj/x64/Release/example-glue
  TARGETDIR           = ../../android-x86_64/bin
  TARGET              = $(TARGETDIR)/libexample-glueRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../../bx/include"
...
ifeq ($(config),debug)
  OBJDIR              = ../../android-x86_64/obj/Debug/example-glue
  TARGETDIR           = ../../android-x86_64/bin
  TARGET              = $(TARGETDIR)/libexample-glueDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../../bx/include"
...
ifeq ($(config),release)
  OBJDIR              = ../../android-x86_64/obj/Release/example-glue
  TARGETDIR           = ../../android-x86_64/bin
  TARGET              = $(TARGETDIR)/libexample-glueRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../../bx/include"
