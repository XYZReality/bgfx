...
MAKEFILE = example-18-ibl.make

ifeq ($(config),debug32)
  OBJDIR              = ../../wasm2js/obj/x32/Debug/example-18-ibl
  TARGETDIR           = ../../wasm2js/bin
  TARGET              = $(TARGETDIR)/example-18-iblDebug.html
...
ifeq ($(config),release32)
  OBJDIR              = ../../wasm2js/obj/x32/Release/example-18-ibl
  TARGETDIR           = ../../wasm2js/bin
  TARGET              = $(TARGETDIR)/example-18-iblRelease.html
...
ifeq ($(config),debug64)
  OBJDIR              = ../../wasm2js/obj/x64/Debug/example-18-ibl
  TARGETDIR           = ../../wasm2js/bin
  TARGET              = $(TARGETDIR)/example-18-iblDebug.html
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DENTRY_CONFIG_IMPLEMENT_MAIN=1 -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common" -I"../../../../bx/include"
...
ifeq ($(config),release64)
  OBJDIR              = ../../wasm2js/obj/x64/Release/example-18-ibl
  TARGETDIR           = ../../wasm2js/bin
  TARGET              = $(TARGETDIR)/example-18-iblRelease.html
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DENTRY_CONFIG_IMPLEMENT_MAIN=1 -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common" -I"../../../../bx/include"
...
ifeq ($(config),debug)
  OBJDIR              = ../../wasm2js/obj/Debug/example-18-ibl
  TARGETDIR           = ../../wasm2js/bin
  TARGET              = $(TARGETDIR)/example-18-iblDebug.html
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DENTRY_CONFIG_IMPLEMENT_MAIN=1 -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common" -I"../../../../bx/include"
...
ifeq ($(config),release)
  OBJDIR              = ../../wasm2js/obj/Release/example-18-ibl
  TARGETDIR           = ../../wasm2js/bin
  TARGET              = $(TARGETDIR)/example-18-iblRelease.html
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DENTRY_CONFIG_IMPLEMENT_MAIN=1 -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common" -I"../../../../bx/include"
