...
ifeq ($(config),debug32)
  OBJDIR              = ../../wasm2js/obj/x32/Debug/bimg
...
ifeq ($(config),release32)
  OBJDIR              = ../../wasm2js/obj/x32/Release/bimg
  TARGETDIR           = ../../wasm2js/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../../wasm2js/obj/x64/Debug/bimg
  TARGETDIR           = ../../wasm2js/bin
  TARGET              = $(TARGETDIR)/bimgDebug.bc
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bimg/include" -I"../../../../bimg/3rdparty/astc-encoder/include" -I"../../../../bimg/3rdparty/tinyexr/deps/miniz" -I"../../../../bx/include"
...
ifeq ($(config),release64)
  OBJDIR              = ../../wasm2js/obj/x64/Release/bimg
  TARGETDIR           = ../../wasm2js/bin
  TARGET              = $(TARGETDIR)/bimgRelease.bc
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bimg/include" -I"../../../../bimg/3rdparty/astc-encoder/include" -I"../../../../bimg/3rdparty/tinyexr/deps/miniz" -I"../../../../bx/include"
...
ifeq ($(config),release)
  OBJDIR              = ../../wasm2js/obj/Release/bimg
  TARGETDIR           = ../../wasm2js/bin
  TARGET              = $(TARGETDIR)/bimgRelease.bc
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bimg/include" -I"../../../../bimg/3rdparty/astc-encoder/include" -I"../../../../bimg/3rdparty/tinyexr/deps/miniz" -I"../../../../bx/include"
