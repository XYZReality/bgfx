...
ifeq ($(config),debug32)
  OBJDIR              = ../../android-x86/obj/x32/Debug/bimg
...
ifeq ($(config),release32)
  OBJDIR              = ../../android-x86/obj/x32/Release/bimg
  TARGETDIR           = ../../android-x86/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../../android-x86/obj/x64/Debug/bimg
  TARGETDIR           = ../../android-x86/bin
  TARGET              = $(TARGETDIR)/libbimgDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bimg/include" -I"../../../../bimg/3rdparty/astc-encoder/include" -I"../../../../bimg/3rdparty/tinyexr/deps/miniz" -I"../../../../bx/include"
...
ifeq ($(config),release64)
  OBJDIR              = ../../android-x86/obj/x64/Release/bimg
  TARGETDIR           = ../../android-x86/bin
  TARGET              = $(TARGETDIR)/libbimgRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bimg/include" -I"../../../../bimg/3rdparty/astc-encoder/include" -I"../../../../bimg/3rdparty/tinyexr/deps/miniz" -I"../../../../bx/include"
...
ifeq ($(config),debug)
  OBJDIR              = ../../android-x86/obj/Debug/bimg
  TARGETDIR           = ../../android-x86/bin
  TARGET              = $(TARGETDIR)/libbimgDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bimg/include" -I"../../../../bimg/3rdparty/astc-encoder/include" -I"../../../../bimg/3rdparty/tinyexr/deps/miniz" -I"../../../../bx/include"
...
ifeq ($(config),release)
  OBJDIR              = ../../android-x86/obj/Release/bimg
  TARGETDIR           = ../../android-x86/bin
  TARGET              = $(TARGETDIR)/libbimgRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bimg/include" -I"../../../../bimg/3rdparty/astc-encoder/include" -I"../../../../bimg/3rdparty/tinyexr/deps/miniz" -I"../../../../bx/include"
