...
ifeq ($(config),debug32)
  OBJDIR              = ../../android-x86/obj/x32/Debug/bgfx-shared-lib
  ...
  ALL_LDFLAGS        += $(LDFLAGS) -L"." -L"../../android-x86/bin" -shared --gcc-toolchain=$(ANDROID_NDK_ROOT)/toolchains/llvm/prebuilt/linux-x86_64 --sysroot=$(ANDROID_NDK_ROOT)/toolchains/llvm/prebuilt/linux-x86_64/sysroot -no-canonical-prefixes -Wl,--no-undefined -Wl,-z,noexecstack -Wl,-z,relro -Wl,-z,now --target=i686-none-linux-android24 -Wl,-soname,libbgfx-shared-libDebug.so
  LIBDEPS            += ../../android-x86/bin/libbimgDebug.a ../../android-x86/bin/libbxDebug.a
  LDDEPS             += ../../android-x86/bin/libbimgDebug.a ../../android-x86/bin/libbxDebug.a
  LDRESP              =
...
ifeq ($(config),release32)
  OBJDIR              = ../../android-x86/obj/x32/Release/bgfx-shared-lib
  TARGETDIR           = ../../android-x86/bin
  ...
  ALL_OBJCPPFLAGS    += $(CXXFLAGS) $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -ffast-math -fomit-frame-pointer -g -O3 -fPIC -std=c++14 -fno-rtti -fno-exceptions --gcc-toolchain=$(ANDROID_NDK_ROOT)/toolchains/llvm/prebuilt/linux-x86_64 --sysroot=$(ANDROID_NDK_ROOT)/toolchains/llvm/prebuilt/linux-x86_64/sysroot -DANDROID -fPIC -no-canonical-prefixes -Wa,--noexecstack -fstack-protector-strong -ffunction-sections -Wunused-value -Wundef --target=i686-none-linux-android24 -mtune=atom -mstackrealign -mfpmath=sse
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L"." -L"../../android-x86/bin" -shared --gcc-toolchain=$(ANDROID_NDK_ROOT)/toolchains/llvm/prebuilt/linux-x86_64 --sysroot=$(ANDROID_NDK_ROOT)/toolchains/llvm/prebuilt/linux-x86_64/sysroot -no-canonical-prefixes -Wl,--no-undefined -Wl,-z,noexecstack -Wl,-z,relro -Wl,-z,now --target=i686-none-linux-android24 -Wl,-soname,libbgfx-shared-libRelease.so
  LIBDEPS            += ../../android-x86/bin/libbimgRelease.a ../../android-x86/bin/libbxRelease.a
  LDDEPS             += ../../android-x86/bin/libbimgRelease.a ../../android-x86/bin/libbxRelease.a
  LDRESP              =
  LIBS               += $(LDDEPS) -lc -ldl -lm -landroid -llog -lc++_shared -lEGL -lGLESv2
  EXTERNAL_LIBS      +=
  LINKOBJS            = $(OBJECTS)
...
ifeq ($(config),debug64)
  OBJDIR              = ../../android-x86/obj/x64/Debug/bgfx-shared-lib
  TARGETDIR           = ../../android-x86/bin
  TARGET              = $(TARGETDIR)/libbgfx-shared-libDebug.so
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBGFX_SHARED_LIB_BUILD=1 -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../3rdparty" -I"../../../../bimg/include" -I"../../../../bx/include" -I"../../../3rdparty/khronos" -I"../../../include"
...
ifeq ($(config),release64)
  OBJDIR              = ../../android-x86/obj/x64/Release/bgfx-shared-lib
  TARGETDIR           = ../../android-x86/bin
  TARGET              = $(TARGETDIR)/libbgfx-shared-libRelease.so
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBGFX_SHARED_LIB_BUILD=1 -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../3rdparty" -I"../../../../bimg/include" -I"../../../../bx/include" -I"../../../3rdparty/khronos" -I"../../../include"
...
ifeq ($(config),debug)
  OBJDIR              = ../../android-x86/obj/Debug/bgfx-shared-lib
  TARGETDIR           = ../../android-x86/bin
  TARGET              = $(TARGETDIR)/libbgfx-shared-libDebug.so
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBGFX_SHARED_LIB_BUILD=1 -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../3rdparty" -I"../../../../bimg/include" -I"../../../../bx/include" -I"../../../3rdparty/khronos" -I"../../../include"
...
ifeq ($(config),release)
  OBJDIR              = ../../android-x86/obj/Release/bgfx-shared-lib
  TARGETDIR           = ../../android-x86/bin
  TARGET              = $(TARGETDIR)/libbgfx-shared-libRelease.so
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBGFX_SHARED_LIB_BUILD=1 -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../3rdparty" -I"../../../../bimg/include" -I"../../../../bx/include" -I"../../../3rdparty/khronos" -I"../../../include"
