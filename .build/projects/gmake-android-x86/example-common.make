...
ifeq ($(config),debug32)
  OBJDIR              = ../../android-x86/obj/x32/Debug/example-common
...
ifeq ($(config),release32)
  OBJDIR              = ../../android-x86/obj/x32/Release/example-common
  TARGETDIR           = ../../android-x86/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../../android-x86/obj/x64/Debug/example-common
  TARGETDIR           = ../../android-x86/bin
  TARGET              = $(TARGETDIR)/libexample-commonDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../../bx/include" -I"../../../3rdparty/native_app_glue"
...
ifeq ($(config),release64)
  OBJDIR              = ../../android-x86/obj/x64/Release/example-common
  TARGETDIR           = ../../android-x86/bin
  TARGET              = $(TARGETDIR)/libexample-commonRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../../bx/include" -I"../../../3rdparty/native_app_glue"
...
ifeq ($(config),debug)
  OBJDIR              = ../../android-x86/obj/Debug/example-common
  TARGETDIR           = ../../android-x86/bin
  TARGET              = $(TARGETDIR)/libexample-commonDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../../bx/include" -I"../../../3rdparty/native_app_glue"
...
ifeq ($(config),release)
  OBJDIR              = ../../android-x86/obj/Release/example-common
  TARGETDIR           = ../../android-x86/bin
  TARGET              = $(TARGETDIR)/libexample-commonRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../../bx/include" -I"../../../3rdparty/native_app_glue"
