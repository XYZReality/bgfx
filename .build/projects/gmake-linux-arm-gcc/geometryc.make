...
ifeq ($(config),debug32)
  OBJDIR              = ../../linux_arm_gcc/obj/x32/Debug/geometryc
...
ifeq ($(config),release32)
  OBJDIR              = ../../linux_arm_gcc/obj/x32/Release/geometryc
  TARGETDIR           = ../../linux_arm_gcc/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../../linux_arm_gcc/obj/x64/Debug/geometryc
  TARGETDIR           = ../../linux_arm_gcc/bin
  TARGET              = $(TARGETDIR)/geometrycDebug
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../bx/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common"
...
ifeq ($(config),release64)
  OBJDIR              = ../../linux_arm_gcc/obj/x64/Release/geometryc
  TARGETDIR           = ../../linux_arm_gcc/bin
  TARGET              = $(TARGETDIR)/geometrycRelease
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../bx/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common"
...
ifeq ($(config),debug)
  OBJDIR              = ../../linux_arm_gcc/obj/Debug/geometryc
  TARGETDIR           = ../../linux_arm_gcc/bin
  TARGET              = $(TARGETDIR)/geometrycDebug
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../bx/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common"
...
ifeq ($(config),release)
  OBJDIR              = ../../linux_arm_gcc/obj/Release/geometryc
  TARGETDIR           = ../../linux_arm_gcc/bin
  TARGET              = $(TARGETDIR)/geometrycRelease
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../bx/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common"
