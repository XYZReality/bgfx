...
ifeq ($(config),debug32)
  OBJDIR              = ../../linux_arm_gcc/obj/x32/Debug/geometryv
  ...
  LIBDEPS            += ../../linux_arm_gcc/bin/libexample-commonDebug.a ../../linux_arm_gcc/bin/libbimg_decodeDebug.a ../../linux_arm_gcc/bin/libbimgDebug.a ../../linux_arm_gcc/bin/libbgfxDebug.a ../../linux_arm_gcc/bin/libbxDebug.a
  LDDEPS             += ../../linux_arm_gcc/bin/libexample-commonDebug.a ../../linux_arm_gcc/bin/libbimg_decodeDebug.a ../../linux_arm_gcc/bin/libbimgDebug.a ../../linux_arm_gcc/bin/libbgfxDebug.a ../../linux_arm_gcc/bin/libbxDebug.a
  LDRESP              =
...
ifeq ($(config),release32)
  OBJDIR              = ../../linux_arm_gcc/obj/x32/Release/geometryv
  TARGETDIR           = ../../linux_arm_gcc/bin
  ...
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L"../../../3rdparty/lib/linux_arm_gcc" -L"." -L"../../linux_arm_gcc/bin" -Wl,--gc-sections
  LIBDEPS            += ../../linux_arm_gcc/bin/libexample-commonRelease.a ../../linux_arm_gcc/bin/libbimg_decodeRelease.a ../../linux_arm_gcc/bin/libbimgRelease.a ../../linux_arm_gcc/bin/libbgfxRelease.a ../../linux_arm_gcc/bin/libbxRelease.a
  LDDEPS             += ../../linux_arm_gcc/bin/libexample-commonRelease.a ../../linux_arm_gcc/bin/libbimg_decodeRelease.a ../../linux_arm_gcc/bin/libbimgRelease.a ../../linux_arm_gcc/bin/libbgfxRelease.a ../../linux_arm_gcc/bin/libbxRelease.a
  LDRESP              =
  LIBS               += $(LDDEPS) -lrt -ldl -lX11 -lGL -lpthread
  EXTERNAL_LIBS      +=
  LINKOBJS            = $(OBJECTS)
...
ifeq ($(config),debug64)
  OBJDIR              = ../../linux_arm_gcc/obj/x64/Debug/geometryv
  TARGETDIR           = ../../linux_arm_gcc/bin
  TARGET              = $(TARGETDIR)/geometryvDebug
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common" -I"../../../../bx/include"
...
ifeq ($(config),release64)
  OBJDIR              = ../../linux_arm_gcc/obj/x64/Release/geometryv
  TARGETDIR           = ../../linux_arm_gcc/bin
  TARGET              = $(TARGETDIR)/geometryvRelease
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common" -I"../../../../bx/include"
...
ifeq ($(config),debug)
  OBJDIR              = ../../linux_arm_gcc/obj/Debug/geometryv
  TARGETDIR           = ../../linux_arm_gcc/bin
  TARGET              = $(TARGETDIR)/geometryvDebug
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common" -I"../../../../bx/include"
...
ifeq ($(config),release)
  OBJDIR              = ../../linux_arm_gcc/obj/Release/geometryv
  TARGETDIR           = ../../linux_arm_gcc/bin
  TARGET              = $(TARGETDIR)/geometryvRelease
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common" -I"../../../../bx/include"
