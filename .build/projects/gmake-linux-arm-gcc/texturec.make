...
ifeq ($(config),debug32)
  OBJDIR              = ../../linux32_arm_gcc/obj/x32/Debug/texturec
  ...
  LIBDEPS            += ../../linux32_arm_gcc/bin/libbimg_decodeDebug.a ../../linux32_arm_gcc/bin/libbimg_encodeDebug.a ../../linux32_arm_gcc/bin/libbimgDebug.a ../../linux32_arm_gcc/bin/libbxDebug.a
  LDDEPS             += ../../linux32_arm_gcc/bin/libbimg_decodeDebug.a ../../linux32_arm_gcc/bin/libbimg_encodeDebug.a ../../linux32_arm_gcc/bin/libbimgDebug.a ../../linux32_arm_gcc/bin/libbxDebug.a
  LDRESP              =
  LIBS               += $(LDDEPS) -lrt -ldl
  EXTERNAL_LIBS      +=
  LINKOBJS            = $(OBJECTS)
...
ifeq ($(config),release32)
  OBJDIR              = ../../linux32_arm_gcc/obj/x32/Release/texturec
  TARGETDIR           = ../../linux32_arm_gcc/bin
  ...
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L"../../../3rdparty/lib/linux32_arm_gcc" -L"." -L"../../linux32_arm_gcc/bin" -Wl,--gc-sections
  LIBDEPS            += ../../linux32_arm_gcc/bin/libbimg_decodeRelease.a ../../linux32_arm_gcc/bin/libbimg_encodeRelease.a ../../linux32_arm_gcc/bin/libbimgRelease.a ../../linux32_arm_gcc/bin/libbxRelease.a
  LDDEPS             += ../../linux32_arm_gcc/bin/libbimg_decodeRelease.a ../../linux32_arm_gcc/bin/libbimg_encodeRelease.a ../../linux32_arm_gcc/bin/libbimgRelease.a ../../linux32_arm_gcc/bin/libbxRelease.a
  LDRESP              =
  LIBS               += $(LDDEPS) -lrt -ldl
  EXTERNAL_LIBS      +=
  LINKOBJS            = $(OBJECTS)
...
ifeq ($(config),debug64)
  OBJDIR              = ../../linux32_arm_gcc/obj/x64/Debug/texturec
  TARGETDIR           = ../../linux32_arm_gcc/bin
  TARGET              = $(TARGETDIR)/texturecDebug
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../bimg/include" -I"../../../include" -I"../../../../bimg/3rdparty/iqa/include" -I"../../../../bx/include"
...
ifeq ($(config),release64)
  OBJDIR              = ../../linux32_arm_gcc/obj/x64/Release/texturec
  TARGETDIR           = ../../linux32_arm_gcc/bin
  TARGET              = $(TARGETDIR)/texturecRelease
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../bimg/include" -I"../../../include" -I"../../../../bimg/3rdparty/iqa/include" -I"../../../../bx/include"
...
ifeq ($(config),debug)
  OBJDIR              = ../../linux32_arm_gcc/obj/Debug/texturec
  TARGETDIR           = ../../linux32_arm_gcc/bin
  TARGET              = $(TARGETDIR)/texturecDebug
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../bimg/include" -I"../../../include" -I"../../../../bimg/3rdparty/iqa/include" -I"../../../../bx/include"
...
ifeq ($(config),release)
  OBJDIR              = ../../linux32_arm_gcc/obj/Release/texturec
  TARGETDIR           = ../../linux32_arm_gcc/bin
  TARGET              = $(TARGETDIR)/texturecRelease
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../bimg/include" -I"../../../include" -I"../../../../bimg/3rdparty/iqa/include" -I"../../../../bx/include"
