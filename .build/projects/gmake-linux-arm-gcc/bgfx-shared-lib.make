...
ifeq ($(config),debug32)
  OBJDIR              = ../../linux_arm_gcc/obj/x32/Debug/bgfx-shared-lib
  ...
  ALL_LDFLAGS        += $(LDFLAGS) -L"../../../3rdparty/lib/linux_arm_gcc" -L"." -L"../../linux_arm_gcc/bin" -shared -Wl,--gc-sections
  LIBDEPS            += ../../linux_arm_gcc/bin/libbimgDebug.a ../../linux_arm_gcc/bin/libbxDebug.a
  LDDEPS             += ../../linux_arm_gcc/bin/libbimgDebug.a ../../linux_arm_gcc/bin/libbxDebug.a
  LDRESP              =
...
ifeq ($(config),release32)
  OBJDIR              = ../../linux_arm_gcc/obj/x32/Release/bgfx-shared-lib
  TARGETDIR           = ../../linux_arm_gcc/bin
  ...
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L"../../../3rdparty/lib/linux_arm_gcc" -L"." -L"../../linux_arm_gcc/bin" -shared -Wl,--gc-sections
  LIBDEPS            += ../../linux_arm_gcc/bin/libbimgRelease.a ../../linux_arm_gcc/bin/libbxRelease.a
  LDDEPS             += ../../linux_arm_gcc/bin/libbimgRelease.a ../../linux_arm_gcc/bin/libbxRelease.a
  LDRESP              =
  LIBS               += $(LDDEPS) -lrt -ldl -lX11 -lGL -lpthread
  EXTERNAL_LIBS      +=
  LINKOBJS            = $(OBJECTS)
...
ifeq ($(config),debug64)
  OBJDIR              = ../../linux_arm_gcc/obj/x64/Debug/bgfx-shared-lib
  TARGETDIR           = ../../linux_arm_gcc/bin
  TARGET              = $(TARGETDIR)/libbgfx-shared-libDebug.so
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBGFX_SHARED_LIB_BUILD=1 -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../3rdparty" -I"../../../../bimg/include" -I"../../../../bx/include" -I"../../../3rdparty/directx-headers/include/directx" -I"../../../3rdparty/directx-headers/include" -I"../../../3rdparty/directx-headers/include/wsl/stubs" -I"../../../3rdparty/khronos" -I"../../../include"
...
ifeq ($(config),release64)
  OBJDIR              = ../../linux_arm_gcc/obj/x64/Release/bgfx-shared-lib
  TARGETDIR           = ../../linux_arm_gcc/bin
  TARGET              = $(TARGETDIR)/libbgfx-shared-libRelease.so
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBGFX_SHARED_LIB_BUILD=1 -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../3rdparty" -I"../../../../bimg/include" -I"../../../../bx/include" -I"../../../3rdparty/directx-headers/include/directx" -I"../../../3rdparty/directx-headers/include" -I"../../../3rdparty/directx-headers/include/wsl/stubs" -I"../../../3rdparty/khronos" -I"../../../include"
...
ifeq ($(config),debug)
  OBJDIR              = ../../linux_arm_gcc/obj/Debug/bgfx-shared-lib
  TARGETDIR           = ../../linux_arm_gcc/bin
  TARGET              = $(TARGETDIR)/libbgfx-shared-libDebug.so
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBGFX_SHARED_LIB_BUILD=1 -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../3rdparty" -I"../../../../bimg/include" -I"../../../../bx/include" -I"../../../3rdparty/directx-headers/include/directx" -I"../../../3rdparty/directx-headers/include" -I"../../../3rdparty/directx-headers/include/wsl/stubs" -I"../../../3rdparty/khronos" -I"../../../include"
...
ifeq ($(config),release)
  OBJDIR              = ../../linux_arm_gcc/obj/Release/bgfx-shared-lib
  TARGETDIR           = ../../linux_arm_gcc/bin
  TARGET              = $(TARGETDIR)/libbgfx-shared-libRelease.so
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBGFX_SHARED_LIB_BUILD=1 -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../3rdparty" -I"../../../../bimg/include" -I"../../../../bx/include" -I"../../../3rdparty/directx-headers/include/directx" -I"../../../3rdparty/directx-headers/include" -I"../../../3rdparty/directx-headers/include/wsl/stubs" -I"../../../3rdparty/khronos" -I"../../../include"
