...
ifeq ($(config),debug32)
  OBJDIR              = ../../linux_arm_gcc/obj/x32/Debug/example-glue
...
ifeq ($(config),release32)
  OBJDIR              = ../../linux_arm_gcc/obj/x32/Release/example-glue
  TARGETDIR           = ../../linux_arm_gcc/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../../linux_arm_gcc/obj/x64/Debug/example-glue
  TARGETDIR           = ../../linux_arm_gcc/bin
  TARGET              = $(TARGETDIR)/libexample-glueDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../../bx/include"
...
ifeq ($(config),release64)
  OBJDIR              = ../../linux_arm_gcc/obj/x64/Release/example-glue
  TARGETDIR           = ../../linux_arm_gcc/bin
  TARGET              = $(TARGETDIR)/libexample-glueRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../../bx/include"
...
ifeq ($(config),debug)
  OBJDIR              = ../../linux_arm_gcc/obj/Debug/example-glue
  TARGETDIR           = ../../linux_arm_gcc/bin
  TARGET              = $(TARGETDIR)/libexample-glueDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../../bx/include"
...
ifeq ($(config),release)
  OBJDIR              = ../../linux_arm_gcc/obj/Release/example-glue
  TARGETDIR           = ../../linux_arm_gcc/bin
  TARGET              = $(TARGETDIR)/libexample-glueRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../../bx/include"
