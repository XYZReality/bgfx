...
ifeq ($(config),debug32)
  OBJDIR              = ../../orin/obj/x32/Debug/texturec
  TARGETDIR           = ../../orin/bin
  ...
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../../../../../opt/vc/include" -I"../../../../../../../../opt/vc/include/interface/vcos/pthreads" -I"../../../../../../../../opt/vc/include/interface/vmcs_host/linux" -I"../../../../bimg/include" -I"../../../include" -I"../../../../bimg/3rdparty/iqa/include" -I"../../../../bx/include"
  ...
  LIBDEPS            += ../../orin/bin/libbimg_decodeDebug.a ../../orin/bin/libbimg_encodeDebug.a ../../orin/bin/libbimgDebug.a ../../orin/bin/libbxDebug.a
  LDDEPS             += ../../orin/bin/libbimg_decodeDebug.a ../../orin/bin/libbimg_encodeDebug.a ../../orin/bin/libbimgDebug.a ../../orin/bin/libbxDebug.a
  LDRESP              =
  LIBS               += $(LDDEPS) -lrt -ldl
  EXTERNAL_LIBS      +=
  LINKOBJS            = $(OBJECTS)
...
ifeq ($(config),release32)
  OBJDIR              = ../../orin/obj/x32/Release/texturec
  TARGETDIR           = ../../orin/bin
  ...
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L"../../../3rdparty/lib/orin" -L"../../../../../../../../opt/vc/lib" -L"." -L"../../orin/bin" -Wl,--gc-sections
  LIBDEPS            += ../../orin/bin/libbimg_decodeRelease.a ../../orin/bin/libbimg_encodeRelease.a ../../orin/bin/libbimgRelease.a ../../orin/bin/libbxRelease.a
  LDDEPS             += ../../orin/bin/libbimg_decodeRelease.a ../../orin/bin/libbimg_encodeRelease.a ../../orin/bin/libbimgRelease.a ../../orin/bin/libbxRelease.a
  LDRESP              =
  LIBS               += $(LDDEPS) -lrt -ldl
  EXTERNAL_LIBS      +=
  LINKOBJS            = $(OBJECTS)
...
ifeq ($(config),debug64)
  OBJDIR              = ../../orin/obj/x64/Debug/texturec
  TARGETDIR           = ../../orin/bin
  TARGET              = $(TARGETDIR)/texturecDebug
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../../../../../opt/vc/include" -I"../../../../../../../../opt/vc/include/interface/vcos/pthreads" -I"../../../../../../../../opt/vc/include/interface/vmcs_host/linux" -I"../../../../bimg/include" -I"../../../include" -I"../../../../bimg/3rdparty/iqa/include" -I"../../../../bx/include"
...
ifeq ($(config),release64)
  OBJDIR              = ../../orin/obj/x64/Release/texturec
  TARGETDIR           = ../../orin/bin
  TARGET              = $(TARGETDIR)/texturecRelease
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../../../../../opt/vc/include" -I"../../../../../../../../opt/vc/include/interface/vcos/pthreads" -I"../../../../../../../../opt/vc/include/interface/vmcs_host/linux" -I"../../../../bimg/include" -I"../../../include" -I"../../../../bimg/3rdparty/iqa/include" -I"../../../../bx/include"
...
ifeq ($(config),debug)
  OBJDIR              = ../../orin/obj/Debug/texturec
  TARGETDIR           = ../../orin/bin
  TARGET              = $(TARGETDIR)/texturecDebug
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../../../../../opt/vc/include" -I"../../../../../../../../opt/vc/include/interface/vcos/pthreads" -I"../../../../../../../../opt/vc/include/interface/vmcs_host/linux" -I"../../../../bimg/include" -I"../../../include" -I"../../../../bimg/3rdparty/iqa/include" -I"../../../../bx/include"
...
ifeq ($(config),release)
  OBJDIR              = ../../orin/obj/Release/texturec
  TARGETDIR           = ../../orin/bin
  TARGET              = $(TARGETDIR)/texturecRelease
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../../../../../opt/vc/include" -I"../../../../../../../../opt/vc/include/interface/vcos/pthreads" -I"../../../../../../../../opt/vc/include/interface/vmcs_host/linux" -I"../../../../bimg/include" -I"../../../include" -I"../../../../bimg/3rdparty/iqa/include" -I"../../../../bx/include"
