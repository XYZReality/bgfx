...
ifeq ($(config),debug32)
  OBJDIR              = ../../orin/obj/x32/Debug/geometryc
  TARGETDIR           = ../../orin/bin
  ...
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../../../../../opt/vc/include" -I"../../../../../../../../opt/vc/include/interface/vcos/pthreads" -I"../../../../../../../../opt/vc/include/interface/vmcs_host/linux" -I"../../../../bx/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common"
...
ifeq ($(config),release32)
  OBJDIR              = ../../orin/obj/x32/Release/geometryc
  TARGETDIR           = ../../orin/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../../orin/obj/x64/Debug/geometryc
  TARGETDIR           = ../../orin/bin
  TARGET              = $(TARGETDIR)/geometrycDebug
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../../../../../opt/vc/include" -I"../../../../../../../../opt/vc/include/interface/vcos/pthreads" -I"../../../../../../../../opt/vc/include/interface/vmcs_host/linux" -I"../../../../bx/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common"
...
ifeq ($(config),release64)
  OBJDIR              = ../../orin/obj/x64/Release/geometryc
  TARGETDIR           = ../../orin/bin
  TARGET              = $(TARGETDIR)/geometrycRelease
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../../../../../opt/vc/include" -I"../../../../../../../../opt/vc/include/interface/vcos/pthreads" -I"../../../../../../../../opt/vc/include/interface/vmcs_host/linux" -I"../../../../bx/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common"
...
ifeq ($(config),debug)
  OBJDIR              = ../../orin/obj/Debug/geometryc
  TARGETDIR           = ../../orin/bin
  TARGET              = $(TARGETDIR)/geometrycDebug
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../../../../../opt/vc/include" -I"../../../../../../../../opt/vc/include/interface/vcos/pthreads" -I"../../../../../../../../opt/vc/include/interface/vmcs_host/linux" -I"../../../../bx/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common"
...
ifeq ($(config),release)
  OBJDIR              = ../../orin/obj/Release/geometryc
  TARGETDIR           = ../../orin/bin
  TARGET              = $(TARGETDIR)/geometrycRelease
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../../../../../opt/vc/include" -I"../../../../../../../../opt/vc/include/interface/vcos/pthreads" -I"../../../../../../../../opt/vc/include/interface/vmcs_host/linux" -I"../../../../bx/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common"
