...
ifeq ($(config),debug32)
  OBJDIR              = ../../orin/obj/x32/Debug/geometryv
  TARGETDIR           = ../../orin/bin
...
ifeq ($(config),release32)
  OBJDIR              = ../../orin/obj/x32/Release/geometryv
  TARGETDIR           = ../../orin/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../../orin/obj/x64/Debug/geometryv
  TARGETDIR           = ../../orin/bin
  TARGET              = $(TARGETDIR)/geometryvDebug
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../../../../../opt/vc/include" -I"../../../../../../../../opt/vc/include/interface/vcos/pthreads" -I"../../../../../../../../opt/vc/include/interface/vmcs_host/linux" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common" -I"../../../../bx/include"
...
ifeq ($(config),release64)
  OBJDIR              = ../../orin/obj/x64/Release/geometryv
  TARGETDIR           = ../../orin/bin
  TARGET              = $(TARGETDIR)/geometryvRelease
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../../../../../opt/vc/include" -I"../../../../../../../../opt/vc/include/interface/vcos/pthreads" -I"../../../../../../../../opt/vc/include/interface/vmcs_host/linux" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common" -I"../../../../bx/include"
...
ifeq ($(config),debug)
  OBJDIR              = ../../orin/obj/Debug/geometryv
  TARGETDIR           = ../../orin/bin
  TARGET              = $(TARGETDIR)/geometryvDebug
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../../../../../opt/vc/include" -I"../../../../../../../../opt/vc/include/interface/vcos/pthreads" -I"../../../../../../../../opt/vc/include/interface/vmcs_host/linux" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common" -I"../../../../bx/include"
...
ifeq ($(config),release)
  OBJDIR              = ../../orin/obj/Release/geometryv
  TARGETDIR           = ../../orin/bin
  TARGET              = $(TARGETDIR)/geometryvRelease
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/linux" -I"../../../../../../../../opt/vc/include" -I"../../../../../../../../opt/vc/include/interface/vcos/pthreads" -I"../../../../../../../../opt/vc/include/interface/vmcs_host/linux" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common" -I"../../../../bx/include"
