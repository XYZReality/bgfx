...
ifeq ($(config),debug32)
  OBJDIR              = ../../android-arm/obj/x32/Debug/bx
  ...
  ALL_LDFLAGS        += $(LDFLAGS) -L"." --gcc-toolchain=$(ANDROID_NDK_ROOT)/toolchains/llvm/prebuilt/linux-x86_64 --sysroot=$(ANDROID_NDK_ROOT)/toolchains/llvm/prebuilt/linux-x86_64/sysroot -no-canonical-prefixes -Wl,--no-undefined -Wl,-z,noexecstack -Wl,-z,relro -Wl,-z,now --target=armv7-none-linux-android24 -march=armv7-a
  LIBDEPS            +=
  LDDEPS             +=
  LDRESP              =
...
ifeq ($(config),release32)
  OBJDIR              = ../../android-arm/obj/x32/Release/bx
  TARGETDIR           = ../../android-arm/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../../android-arm/obj/x64/Debug/bx
  TARGETDIR           = ../../android-arm/bin
  TARGET              = $(TARGETDIR)/libbxDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bx/3rdparty"
...
ifeq ($(config),release64)
  OBJDIR              = ../../android-arm/obj/x64/Release/bx
  TARGETDIR           = ../../android-arm/bin
  TARGET              = $(TARGETDIR)/libbxRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bx/3rdparty"
...
ifeq ($(config),debug)
  OBJDIR              = ../../android-arm/obj/Debug/bx
  TARGETDIR           = ../../android-arm/bin
  TARGET              = $(TARGETDIR)/libbxDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bx/3rdparty"
...
ifeq ($(config),release)
  OBJDIR              = ../../android-arm/obj/Release/bx
  TARGETDIR           = ../../android-arm/bin
  TARGET              = $(TARGETDIR)/libbxRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include" -I"../../../../bx/3rdparty"
