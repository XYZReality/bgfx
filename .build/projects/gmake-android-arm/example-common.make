...
ifeq ($(config),debug32)
  OBJDIR              = ../../android-arm/obj/x32/Debug/example-common
...
ifeq ($(config),release32)
  OBJDIR              = ../../android-arm/obj/x32/Release/example-common
  TARGETDIR           = ../../android-arm/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../../android-arm/obj/x64/Debug/example-common
  TARGETDIR           = ../../android-arm/bin
  TARGET              = $(TARGETDIR)/libexample-commonDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../../bx/include" -I"../../../3rdparty/native_app_glue"
...
ifeq ($(config),release64)
  OBJDIR              = ../../android-arm/obj/x64/Release/example-common
  TARGETDIR           = ../../android-arm/bin
  TARGET              = $(TARGETDIR)/libexample-commonRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../../bx/include" -I"../../../3rdparty/native_app_glue"
...
ifeq ($(config),debug)
  OBJDIR              = ../../android-arm/obj/Debug/example-common
  TARGETDIR           = ../../android-arm/bin
  TARGET              = $(TARGETDIR)/libexample-commonDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../../bx/include" -I"../../../3rdparty/native_app_glue"
...
ifeq ($(config),release)
  OBJDIR              = ../../android-arm/obj/Release/example-common
  TARGETDIR           = ../../android-arm/bin
  TARGET              = $(TARGETDIR)/libexample-commonRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../../bx/include" -I"../../../3rdparty/native_app_glue"
