...
ifeq ($(config),debug32)
  OBJDIR              = ../../android-arm/obj/x32/Debug/example-25-c99
...
ifeq ($(config),release32)
  OBJDIR              = ../../android-arm/obj/x32/Release/example-25-c99
  TARGETDIR           = ../../android-arm/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../../android-arm/obj/x64/Debug/example-25-c99
  TARGETDIR           = ../../android-arm/bin
  TARGET              = $(TARGETDIR)/libexample-25-c99Debug.so
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DENTRY_CONFIG_IMPLEMENT_MAIN=1 -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common" -I"../../../../bx/include"
...
ifeq ($(config),release64)
  OBJDIR              = ../../android-arm/obj/x64/Release/example-25-c99
  TARGETDIR           = ../../android-arm/bin
  TARGET              = $(TARGETDIR)/libexample-25-c99Release.so
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DENTRY_CONFIG_IMPLEMENT_MAIN=1 -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common" -I"../../../../bx/include"
...
ifeq ($(config),debug)
  OBJDIR              = ../../android-arm/obj/Debug/example-25-c99
  TARGETDIR           = ../../android-arm/bin
  TARGET              = $(TARGETDIR)/libexample-25-c99Debug.so
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DENTRY_CONFIG_IMPLEMENT_MAIN=1 -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common" -I"../../../../bx/include"
...
ifeq ($(config),release)
  OBJDIR              = ../../android-arm/obj/Release/example-25-c99
  TARGETDIR           = ../../android-arm/bin
  TARGET              = $(TARGETDIR)/libexample-25-c99Release.so
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DENTRY_CONFIG_IMPLEMENT_MAIN=1 -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common" -I"../../../../bx/include"
