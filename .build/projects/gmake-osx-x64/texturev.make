...
ifeq ($(config),debug32)
  OBJDIR              = ../../osx-x64/obj/x32/Debug/texturev
...
ifeq ($(config),release32)
  OBJDIR              = ../../osx-x64/obj/x32/Release/texturev
  TARGETDIR           = ../../osx-x64/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../../osx-x64/obj/x64/Debug/texturev
  TARGETDIR           = ../../osx-x64/bin
  TARGET              = $(TARGETDIR)/texturevDebug
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/osx" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common" -I"../../../../bx/include"
...
ifeq ($(config),release64)
  OBJDIR              = ../../osx-x64/obj/x64/Release/texturev
  TARGETDIR           = ../../osx-x64/bin
  TARGET              = $(TARGETDIR)/texturevRelease
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/osx" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common" -I"../../../../bx/include"
...
ifeq ($(config),debug)
  OBJDIR              = ../../osx-x64/obj/Debug/texturev
  TARGETDIR           = ../../osx-x64/bin
  TARGET              = $(TARGETDIR)/texturevDebug
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/osx" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common" -I"../../../../bx/include"
...
ifeq ($(config),release)
  OBJDIR              = ../../osx-x64/obj/Release/texturev
  TARGETDIR           = ../../osx-x64/bin
  TARGET              = $(TARGETDIR)/texturevRelease
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/osx" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../examples/common" -I"../../../../bx/include"
