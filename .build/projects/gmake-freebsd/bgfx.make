...
ifeq ($(config),debug32)
  OBJDIR              = ../../freebsd/obj/x32/Debug/bgfx
  ...
  INCLUDES           += -I"../../../../bx/include/compat/freebsd" -I"../../../3rdparty" -I"../../../../bimg/include" -I"../../../../bx/include" -I"../../../3rdparty/khronos" -I"../../../include"
...
ifeq ($(config),release32)
  OBJDIR              = ../../freebsd/obj/x32/Release/bgfx
  TARGETDIR           = ../../freebsd/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../../freebsd/obj/x64/Debug/bgfx
  TARGETDIR           = ../../freebsd/bin
  TARGET              = $(TARGETDIR)/libbgfxDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/freebsd" -I"../../../3rdparty" -I"../../../../bimg/include" -I"../../../../bx/include" -I"../../../3rdparty/khronos" -I"../../../include"
...
ifeq ($(config),release64)
  OBJDIR              = ../../freebsd/obj/x64/Release/bgfx
  TARGETDIR           = ../../freebsd/bin
  TARGET              = $(TARGETDIR)/libbgfxRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/freebsd" -I"../../../3rdparty" -I"../../../../bimg/include" -I"../../../../bx/include" -I"../../../3rdparty/khronos" -I"../../../include"
...
ifeq ($(config),release)
  OBJDIR              = ../../freebsd/obj/Release/bgfx
  TARGETDIR           = ../../freebsd/bin
  TARGET              = $(TARGETDIR)/libbgfxRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/freebsd" -I"../../../3rdparty" -I"../../../../bimg/include" -I"../../../../bx/include" -I"../../../3rdparty/khronos" -I"../../../include"
