...
ifeq ($(config),debug32)
  OBJDIR              = ../../freebsd/obj/x32/Debug/bx
  ...
  INCLUDES           += -I"../../../../bx/include/compat/freebsd" -I"../../../../bx/include" -I"../../../../bx/3rdparty"
  ...
  ALL_LDFLAGS        += $(LDFLAGS) -L"../../../3rdparty/lib/freebsd"
  LIBDEPS            +=
  LDDEPS             +=
  LDRESP              =
  LIBS               += $(LDDEPS)
...
ifeq ($(config),release32)
  OBJDIR              = ../../freebsd/obj/x32/Release/bx
  TARGETDIR           = ../../freebsd/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../../freebsd/obj/x64/Debug/bx
  TARGETDIR           = ../../freebsd/bin
  TARGET              = $(TARGETDIR)/libbxDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/freebsd" -I"../../../../bx/include" -I"../../../../bx/3rdparty"
...
ifeq ($(config),release64)
  OBJDIR              = ../../freebsd/obj/x64/Release/bx
  TARGETDIR           = ../../freebsd/bin
  TARGET              = $(TARGETDIR)/libbxRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/freebsd" -I"../../../../bx/include" -I"../../../../bx/3rdparty"
