...
ifeq ($(config),debug32)
  OBJDIR              = ../../ios-simulator/obj/x32/Debug/bx
...
ifeq ($(config),release32)
  OBJDIR              = ../../ios-simulator/obj/x32/Release/bx
  TARGETDIR           = ../../ios-simulator/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../../ios-simulator/obj/x64/Debug/bx
  TARGETDIR           = ../../ios-simulator/bin
  TARGET              = $(TARGETDIR)/libbxDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/ios" -I"../../../../bx/include" -I"../../../../bx/3rdparty"
...
ifeq ($(config),release64)
  OBJDIR              = ../../ios-simulator/obj/x64/Release/bx
  TARGETDIR           = ../../ios-simulator/bin
  TARGET              = $(TARGETDIR)/libbxRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/ios" -I"../../../../bx/include" -I"../../../../bx/3rdparty"
...
ifeq ($(config),debug)
  OBJDIR              = ../../ios-simulator/obj/Debug/bx
  TARGETDIR           = ../../ios-simulator/bin
  TARGET              = $(TARGETDIR)/libbxDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/ios" -I"../../../../bx/include" -I"../../../../bx/3rdparty"
...
ifeq ($(config),release)
  OBJDIR              = ../../ios-simulator/obj/Release/bx
  TARGETDIR           = ../../ios-simulator/bin
  TARGET              = $(TARGETDIR)/libbxRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/ios" -I"../../../../bx/include" -I"../../../../bx/3rdparty"
