...
ifeq ($(config),debug32)
  OBJDIR              = ../../osx-arm64/obj/x32/Debug/bimg_decode
...
ifeq ($(config),release32)
  OBJDIR              = ../../osx-arm64/obj/x32/Release/bimg_decode
  TARGETDIR           = ../../osx-arm64/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../../osx-arm64/obj/x64/Debug/bimg_decode
  TARGETDIR           = ../../osx-arm64/bin
  TARGET              = $(TARGETDIR)/libbimg_decodeDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/osx" -I"../../../../bimg/include" -I"../../../../bimg/3rdparty" -I"../../../../bimg/3rdparty/tinyexr/deps/miniz" -I"../../../../bx/include"
...
ifeq ($(config),release64)
  OBJDIR              = ../../osx-arm64/obj/x64/Release/bimg_decode
  TARGETDIR           = ../../osx-arm64/bin
  TARGET              = $(TARGETDIR)/libbimg_decodeRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/osx" -I"../../../../bimg/include" -I"../../../../bimg/3rdparty" -I"../../../../bimg/3rdparty/tinyexr/deps/miniz" -I"../../../../bx/include"
...
ifeq ($(config),debug)
  OBJDIR              = ../../osx-arm64/obj/Debug/bimg_decode
  TARGETDIR           = ../../osx-arm64/bin
  TARGET              = $(TARGETDIR)/libbimg_decodeDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/osx" -I"../../../../bimg/include" -I"../../../../bimg/3rdparty" -I"../../../../bimg/3rdparty/tinyexr/deps/miniz" -I"../../../../bx/include"
...
ifeq ($(config),release)
  OBJDIR              = ../../osx-arm64/obj/Release/bimg_decode
  TARGETDIR           = ../../osx-arm64/bin
  TARGET              = $(TARGETDIR)/libbimg_decodeRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/osx" -I"../../../../bimg/include" -I"../../../../bimg/3rdparty" -I"../../../../bimg/3rdparty/tinyexr/deps/miniz" -I"../../../../bx/include"
