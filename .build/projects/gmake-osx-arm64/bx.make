...
ifeq ($(config),debug32)
  OBJDIR              = ../../osx-arm64/obj/x32/Debug/bx
...
ifeq ($(config),release32)
  OBJDIR              = ../../osx-arm64/obj/x32/Release/bx
  TARGETDIR           = ../../osx-arm64/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../../osx-arm64/obj/x64/Debug/bx
  TARGETDIR           = ../../osx-arm64/bin
  TARGET              = $(TARGETDIR)/libbxDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/osx" -I"../../../../bx/include" -I"../../../../bx/3rdparty"
...
ifeq ($(config),release64)
  OBJDIR              = ../../osx-arm64/obj/x64/Release/bx
  TARGETDIR           = ../../osx-arm64/bin
  TARGET              = $(TARGETDIR)/libbxRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/osx" -I"../../../../bx/include" -I"../../../../bx/3rdparty"
...
ifeq ($(config),release)
  OBJDIR              = ../../osx-arm64/obj/Release/bx
  TARGETDIR           = ../../osx-arm64/bin
  TARGET              = $(TARGETDIR)/libbxRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/osx" -I"../../../../bx/include" -I"../../../../bx/3rdparty"
