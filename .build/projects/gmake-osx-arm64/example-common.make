...
ifeq ($(config),debug32)
  OBJDIR              = ../../osx-arm64/obj/x32/Debug/example-common
...
ifeq ($(config),release32)
  OBJDIR              = ../../osx-arm64/obj/x32/Release/example-common
  TARGETDIR           = ../../osx-arm64/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../../osx-arm64/obj/x64/Debug/example-common
  TARGETDIR           = ../../osx-arm64/bin
  TARGET              = $(TARGETDIR)/libexample-commonDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/osx" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../../bx/include"
...
ifeq ($(config),release64)
  OBJDIR              = ../../osx-arm64/obj/x64/Release/example-common
  TARGETDIR           = ../../osx-arm64/bin
  TARGET              = $(TARGETDIR)/libexample-commonRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/osx" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../../bx/include"
...
ifeq ($(config),debug)
  OBJDIR              = ../../osx-arm64/obj/Debug/example-common
  TARGETDIR           = ../../osx-arm64/bin
  TARGET              = $(TARGETDIR)/libexample-commonDebug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG -DBX_CONFIG_DEBUG=1
  INCLUDES           += -I"../../../../bx/include/compat/osx" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../../bx/include"
...
ifeq ($(config),release)
  OBJDIR              = ../../osx-arm64/obj/Release/example-common
  TARGETDIR           = ../../osx-arm64/bin
  TARGET              = $(TARGETDIR)/libexample-commonRelease.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -DNDEBUG -DBX_CONFIG_DEBUG=0
  INCLUDES           += -I"../../../../bx/include/compat/osx" -I"../../../../bimg/include" -I"../../../include" -I"../../../3rdparty" -I"../../../../bx/include"
